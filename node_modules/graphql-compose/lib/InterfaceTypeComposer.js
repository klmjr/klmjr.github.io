...
class InterfaceTypeComposer {
  ...
  constructor(graphqlType, schemaComposer) {
    ...
    if (graphqlType === null || graphqlType === void 0 ? void 0 : (_graphqlType$astNode = graphqlType.astNode) === null || _graphqlType$astNode === void 0 ? void 0 : _graphqlType$astNode.directives) {
  ...
  merge(type) {
    ...
    if (type instanceof _graphql.GraphQLInterfaceType || type instanceof _graphql.GraphQLObjectType) {
      tc = this.schemaComposer.createTempTC(type);
    } else if (type instanceof InterfaceTypeComposer || type instanceof _ObjectTypeComposer.ObjectTypeComposer) {
      tc = type;
    }
  ...
  getInputTypeComposer() {
    if (!this._gqcInputTypeComposer) {
      this._gqcInputTypeComposer = (0, _toInputObjectType.toInputObjectType)(this);
    }
  ...
  setTypeResolvers(typeResolversMap) {
    ...
    this._gqcTypeResolvers = typeResolversMap; // extract GraphQLObjectType from ObjectTypeComposer
  ...
  hasInterface(iface) {
    const typeName = (0, _typeHelpers.getComposeTypeName)(iface);
  ...
  toSDL(opts) {
    ...
    if (deep) {
      ...
      if ((opts === null || opts === void 0 ? void 0 : opts.sortAll) || (opts === null || opts === void 0 ? void 0 : opts.sortTypes)) {
