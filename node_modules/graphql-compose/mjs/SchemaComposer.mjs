...
import { GraphQLSchema, GraphQLObjectType, GraphQLInputObjectType, GraphQLInterfaceType, GraphQLUnionType, GraphQLEnumType, GraphQLDirective, GraphQLSkipDirective, GraphQLIncludeDirective, GraphQLDeprecatedDirective, GraphQLScalarType, GraphQLNonNull, GraphQLList, defaultFieldResolver, buildSchema } from './graphql';
...
export class SchemaComposer extends TypeStorage {
  ...
  buildSchema(extraConfig) {
    ...
    if (!description) description = undefined; // $FlowFixMe `description` was added only in graphql@15.0.0

    return new GraphQLSchema(_objectSpread(_objectSpread(_objectSpread({
      description
    }, roots), extraConfig), {}, {
      types,
      directives
